  ...
  return (
    <div className='relFative'>
      ...
      <Section className="flex flex-col-reverse lg:flex-row items-center justify-center h-[55rem] md:h-[70rem] lg:h-[55rem] xl:h-[65rem] lg:gap-10 xl:gap-20 pb-40 pt-10 lg:py-40">
        <div className='w-[80%] lg:w-[25rem] xl:w-[30rem]'>
          <h1><span className='block text-sm md:text-base lg:text-lg'>Hello, <span className='text-accentRed text-sm md:text-base lg:text-lg'>I&apos;m</span></span>
            <span className='block text-3xl lg:text-5xl'>Christian Agra</span>
            <span className='text-xl lg:text-3xl'>A </span><FlipWords words={words} /> <span className='text-xl lg:text-3xl'>Developer</span></h1>
          <p className='text-sm md:text-base lg:text-lg mt-3 lg:mt-5'>With over a year of web development experience,<span className='xl:block' />
            I bring expertise and innovation to every project,<span className='xl:block' />
        ...
        <div className='w-[80%] max-w-[20rem] md:max-w-[25rem]  lg:w-[50%] lg:max-w-[35rem] mb-5 sm:mb-0 md:mb-10 xl:w-auto sm:mt-20 lg:mt-0 '>
          <Image
